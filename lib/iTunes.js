...
var uploadAppStoreDesktop = function uploadAppStoreDesktop(env) {
  return new Promise(function (resolve) {
    ...
    (0, _child_process.execSync)("fastlane mac deploy_desktop", {
      stdio: [0, 1, 2],
      env: env
    });
...
var installCerts = function installCerts(env) {
  return new Promise(function (resolve) {
    if (!_util2.default.hasPlatform("ios")) {
    ...
    (0, _child_process.execSync)("fastlane ios install_certs", {
      stdio: [0, 1, 2],
      env: env
    });
